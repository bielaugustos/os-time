...
export const APP_REGISTRY = [
  ...
  { id: 'quadro',     color: '#f472b6', navKey: 'nav.quadro',     appKey: 'apps.quadro',     iconSize: 26, disabled: true, component: lazy(() => import('../apps/QuadroApp'))      },
  ...
  { id: 'energy',     color: '#a78bfa', navKey: 'nav.energy',     appKey: 'apps.energy',     name: 'Torre', iconSize: 26, component: lazy(() => import('../apps/EnergyApp')) },
